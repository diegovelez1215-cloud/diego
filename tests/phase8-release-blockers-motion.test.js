...
test('Watch live duration targets and Speed up ratio are enforced', () => withApp((app, window, ts2) => {
  ...
  assert.ok(oneWatch >= 35000 && oneWatch <= 55000, `one-leg Watch live target failed: ${oneWatch}`);
  assert.ok(fourWatch >= 55000 && fourWatch <= 90000, `four-leg Watch live target failed: ${fourWatch}`);
